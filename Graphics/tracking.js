...
Elm.Main.make = function (_elm) {
   ...
   var scene = F2(function (_p1,_p0) {
      ...
      _U.list([A2($Graphics$Collage.rotate,
              A2($Basics.atan2,dy,dx),
              A2($Graphics$Collage.filled,
              $Color.red,
              A2($Graphics$Collage.ngon,3,100)))
              ...
              A2($Graphics$Collage.filled,
              $Color.green,
              A2($Graphics$Collage.ngon,6,60))))
              ,A2($Graphics$Collage.move,
              {ctor: "_Tuple2",_0: dx,_1: dy},
              A2($Graphics$Collage.filled,
              $Color.blue,
              A2($Graphics$Collage.ngon,5,20)))
              ,A2($Graphics$Collage.rotate,
              $Basics.degrees(60),
              A2($Graphics$Collage.rotate,
              A2($Basics.atan2,dy,dx),
   ...
   $Mouse.position,
   $Window.dimensions);
   return _elm.Main.values = {_op: _op,main: main,scene: scene};
};
