...
Elm.DoubleCounter = Elm.DoubleCounter || {};
Elm.DoubleCounter.make = function (_elm) {
   "use strict";
   _elm.DoubleCounter = _elm.DoubleCounter || {};
   if (_elm.DoubleCounter.values) return _elm.DoubleCounter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var mainStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                   ,_0: "font-size"
                                                   ,_1: "20px"}
                                                  ,{ctor: "_Tuple2",_0: "font-family",_1: "calibri"}
   ...
   var update = F2(function (action,model) {
      ...
      {case "Increment": return model + 1;
         ...
         case "DoubleIncrement": return model + 2;
         default: return model - 2;}
   });
   var DoubleDecrement = {ctor: "DoubleDecrement"};
   var DoubleIncrement = {ctor: "DoubleIncrement"};
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,DoubleIncrement)]),
              _U.list([$Html.text("++")]))
              ,A2($Html.p,_U.list([]),_U.list([$Html.text("")]))
              ,A2($Html.button,
              ...
              ,A2($Html.p,_U.list([]),_U.list([$Html.text("")]))
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,DoubleDecrement)]),
              _U.list([$Html.text("- -")]))]));
   });
   var init = function (count) {    return count;};
   return _elm.DoubleCounter.values = {_op: _op
                                      ,init: init
                                      ,update: update
                                      ,view: view};
};
Elm.DoubleCounterList = Elm.DoubleCounterList || {};
Elm.DoubleCounterList.make = function (_elm) {
   "use strict";
   _elm.DoubleCounterList = _elm.DoubleCounterList || {};
   if (_elm.DoubleCounterList.values)
   return _elm.DoubleCounterList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $DoubleCounter = Elm.DoubleCounter.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Insert": var newCounter = {ctor: "_Tuple2"
                                       ,_0: model.nextID
                                       ,_1: $DoubleCounter.init(0)};
         ...
         case "Delete": return _U.update(model,
           {counters: A2($List.drop,1,model.counters)});
         default: var updateCounter = function (_p1) {
              var _p2 = _p1;
              var _p4 = _p2._1;
              var _p3 = _p2._0;
              return _U.eq(_p3,_p0._0) ? {ctor: "_Tuple2"
                                         ,_0: _p3
                                         ,_1: A2($DoubleCounter.update,_p0._1,_p4)} : {ctor: "_Tuple2"
                                                                                      ,_0: _p3
                                                                                      ,_1: _p4};
           };
           return _U.update(model,
   ...
   var viewCounter = F2(function (address,_p5) {
      var _p6 = _p5;
      return A2($DoubleCounter.view,
      A2($Signal.forwardTo,address,Edit(_p6._0)),
      _p6._1);
   });
   ...
   var view = F2(function (address,model) {
      ...
      var $delete = A2($Html.button,
      _U.list([A2($Html$Events.onClick,address,Delete)]),
      ...
      return A2($Html.div,
      _U.list([]),
      A2($Basics._op["++"],_U.list([$delete,insert]),counters));
   });
   var init = {counters: _U.list([]),nextID: 0};
   var Model = F2(function (a,b) {
      return {counters: a,nextID: b};
   });
   return _elm.DoubleCounterList.values = {_op: _op
                                          ,Model: Model
                                          ,init: init
                                          ,Insert: Insert
                                          ,Delete: Delete
...
Elm.Main.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $DoubleCounterList = Elm.DoubleCounterList.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var _op = {};
   var main = $StartApp$Simple.start({model: $DoubleCounterList.init
                                     ,update: $DoubleCounterList.update
                                     ,view: $DoubleCounterList.view});
